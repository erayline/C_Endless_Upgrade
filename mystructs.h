...
#define item_count (3 +1)// item adedi (artı biri silme silersen bozuluyor. oradaki dört değişken artı bir sabit fonksiyonda sıfırdan başladığı için artı bir demek zorunda kaldın)
...
#define item_count (2 +1)// item adedi (artı biri silme silersen bozuluyor. oradaki dört değişken artı bir sabit fonksiyonda sıfırdan başladığı için artı bir demek zorunda kaldın)
int enemy_life_bar_width = 30;
int enemy_life_bar_height = 20;
