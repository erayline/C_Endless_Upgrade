...
int processEvents(SDL_Window *window, Man *man,Bullet *mermi, Enemy *enemyler) { // burada işlemler oluyor
...
int main(int argc, char* argv[]) {
	...
	while (!done) {
		...
		done = processEvents(window, &man, &mermi,&enemyler);
		//render display
